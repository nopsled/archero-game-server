📦
124575 /tools/libunity_scanner.js
✄
...
function scan(lib) {
  ...
  const pattern2 = "43 65 72 74 69 66 69 63 61 74 65 20 76 65 72 69 66 69 63 61 74 69 6f 6e 20 66 61 69 6c 65 64";
...
function findReferences(lib, targetAddr) {
  const ranges = Process.enumerateRanges("r-x");
  for (const range of ranges) {
    if (range.base.compare(lib.base) >= 0 && range.base.add(range.size).compare(lib.base.add(lib.size)) <= 0) {
    }
  }
