📦
155049 /android/loggers/port_12020_logger.js
✄
...
// android/loggers/port_12020_logger.ts
console.log("\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557");
      ...
      try {
        ...
        if (typeName === "Byte[]") {
          ...
          if (len > 0 && len <= 256) {
            ...
            if (len > 64)
              hexStr += `...(${len} total)`;
            result[fieldName] = { type: "byte[]", length: len, hex: hexStr };
          } else {
        ...
        if (typeName === "UInt16[]") {
          const len = value.length || 0;
          result[fieldName] = { type: "uint16[]", length: len };
          return;
        }
        if (typeName.endsWith("[]")) {
          const len = value.length || 0;
          result[fieldName] = { type: typeName, length: len };
          return;
        }
        if (typeName.startsWith("List`1")) {
          try {
            const count = value.method("get_Count").invoke();
            result[fieldName] = { type: "List", count: Number(count) };
          } catch (e) {
            result[fieldName] = { type: "List", count: "?" };
          }
          return;
        }
        if (typeName.startsWith("Dictionary`2")) {
          try {
            const count = value.method("get_Count").invoke();
            result[fieldName] = { type: "Dictionary", count: Number(count) };
          } catch (e) {
            result[fieldName] = { type: "Dictionary", count: "?" };
          }
          return;
        }
...
function printFields(fields, indent = "\u2502   ") {
  for (const [key, value] of Object.entries(fields)) {
    if (value && typeof value === "object" && value.fields) {
      ...
      const extra = value.length !== void 0 ? `, len=${value.length}` : value.count !== void 0 ? `, count=${value.count}` : "";
        ...
        onEnter(args) {
          ...
          if (size > 0 && size < 1e4) {
            ...
            try {
              ...
              if (b0 === 22 && b1 === 3) {
                const tlsVersion = b2 === 1 ? "TLS 1.0" : b2 === 2 ? "TLS 1.1" : b2 === 3 ? "TLS 1.2" : b2 === 4 ? "TLS 1.3" : `TLS (0x03${b2.toString(16).padStart(2, "0")})`;
                protocol = `\u{1F512} ${tlsVersion} HANDSHAKE`;
              } else if (b0 === 23 && b1 === 3) {
                protocol = "\u{1F510} TLS Application Data";
              } else if (b0 === 21 && b1 === 3) {
                protocol = "\u26A0\uFE0F TLS Alert";
              } else if (b0 === 20 && b1 === 3) {
                protocol = "\u{1F504} TLS Change Cipher Spec";
              } else if (b0 === 71 && b1 === 69 && b2 === 84) {
                protocol = "\u{1F4C4} HTTP GET";
              } else if (b0 === 80 && b1 === 79 && b2 === 83) {
                protocol = "\u{1F4C4} HTTP POST";
              }
            } catch (e) {
            }
            if (protocol !== "unknown" || size > 16) {
              try {
                ...
                if (protocol.includes("HANDSHAKE"))
                  console.log(hexdump(data, { length: Math.min(size, 128) }));
              } catch (e) {
              }
            }
          }
...
function discoverGameProtocolClasses(asm) {
  console.log(`${ts()} [DISCOVER] Scanning GameProtocol namespace...`);
  const gameProtocolClasses = [];
  try {
    ...
    const loginRelated = gameProtocolClasses.filter((name) => name.toLowerCase().includes("login") || name.toLowerCase().includes("user") || name.toLowerCase().includes("sync") || name.toLowerCase().includes("heartbeat") || name.toLowerCase().includes("resp"));
    ...
    try {
      ...
      try {
        clazz.method("WriteToStream").implementation = function(writer) {
          ...
          console.log(`
${ts()} \u250C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500`);
          console.log(`${ts()} \u2502 \u{1F4E4} PACKET OUT: ${name}`);
          console.log(`${ts()} \u251C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500`);
          printFields(fields);
          console.log(`${ts()} \u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
`);
        ...
        try {
          clazz.method("OnWriteToStream").implementation = function(writer) {
            const fields = dumpAllFields(this);
            console.log(`
${ts()} \u250C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500`);
            console.log(`${ts()} \u2502 \u{1F4E4} PACKET OUT: ${name}`);
...
`);
      ...
      try {
        clazz.method("ReadFromStream").implementation = function(reader) {
          ...
          console.log(`
${ts()} \u250C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500`);
          console.log(`${ts()} \u2502 \u{1F4E5} PACKET IN: ${name}`);
          console.log(`${ts()} \u251C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500`);
          printFields(fields);
          console.log(`${ts()} \u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
`);
    ...
    try {
      ...
      clazz.methods.forEach((method) => {
        ...
        if (patterns.some((p) => method.name.includes(p))) {
          try {
            clazz.method(method.name).implementation = function(...args) {
...
function hookTcpLayer(asm) {
  console.log(`${ts()} [HOOK] TCP layer...`);
  try {
    const tcpServer = asm.class("TcpServer.TcpServer");
    try {
      tcpServer.method("SendPacket").implementation = function(packet) {
    ...
    try {
      tcpServer.method("OnReceive").implementation = function(data, len) {
...
function hookEncryption(asm) {
  ...
  try {
    ...
    for (const methodName of encryptMethods) {
      try {
        netEncrypt.method(methodName).implementation = function(...args) {
  ...
  try {
    ...
    try {
      rc4.method("Encrypt").implementation = function(data) {
...
function hookHttpLayer() {
  ...
  try {
    ...
    httpManager.methods.forEach((method) => {
      if ((method.name.includes("Request") || method.name.includes("Send") || method.name.includes("Post") || method.name.includes("Get")) && !method.name.includes("Update") && !method.name.includes("Kill")) {
        try {
          httpManager.method(method.name).implementation = function(...args) {
  ...
  try {
    ...
    try {
      ...
      httpClient.methods.forEach((method) => {
        if ((method.name.includes("Send") || method.name.includes("Request")) && !method.name.includes("Kill") && !method.name.includes("Update")) {
          try {
            httpClient.method(method.name).implementation = function(...args) {
              let argStrs = [];
              try {
                argStrs = args.map((a) => safeString(a));
              } catch (e) {
                argStrs = ["<formatting error>"];
              }
